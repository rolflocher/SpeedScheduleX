...
class buildingView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var pickerData: [String] = ["-----","CEER","Church", "Dougherty", "Driscoll", "Falvey", "Finn.", "Health Services", "Jake Nevin", "John Barry", "Kennedy", "Law School", "Mendel", "Military Sci.", "Monastery", "St. Augustine", "Steam Plant", "Structural Egr.", "Tolentine", "TSB", "Vasey", "Villanova Center", "White Hall"]
